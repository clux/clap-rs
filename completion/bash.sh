...
_{{ binname }}()
{
    ...
    local -r binname="{{ binname }}"
    local -r subcommands="{{ subcommands }}"
    local -r subcommands_pattern=@({{ subcommands_pattern }})
    local -r global_flags="{{ flags_spaces }}"
